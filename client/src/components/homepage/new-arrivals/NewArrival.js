  ...
  return (
    <section className="w-full">
      ...
      <div className="relative">
        ...
        {!isBeginning && (
          <button
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 p-3 sm:p-4 rounded-full bg-[#00a88f]/80 hover:bg-[#1a7f73] shadow-lg transition-all"
        ...
        {!isEnd && (
          <button
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 p-3 sm:p-4 rounded-full bg-[#00a88f]/80 hover:bg-[#1a7f73] shadow-lg transition-all"
