...
export default function AdminSidebar() {
  ...
  return (
    <div>
      <aside className="hidden md:flex flex-col w-64 min-h-screen sticky top-0 bg-[#00a88f] text-white">
            ...
            {routes.map((route) => {
              ...
              return (
                <motion.a
                  key={route.name}
                  href={route.path}
                  className={`flex items-center gap-3 px-6 py-3 cursor-pointer rounded-lg transition-colors duration-200 
      ...
      <div className="md:hidden w-full bg-[#00a88f]">
